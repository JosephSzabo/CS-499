...
class AnimalShelter(object):
    ...
    def __init__(self, username, password, host='127.0.0.1', port=27017, db_name='AAC', collection_name='animals'):
        ...
        # This is configured for the 'AAC' database and the 'animals' collection.
        # Please update the connection variables below to match your MongoDB instance.
    ...
    # Implement this create method to implement the C in CRUD
    """
    ...
    """
    Input: animal_data (dictionary format) - Filter to find the document to update.
           new_data (dictionary format) - The data to update in the found document.
    Output: Returns the number of modified documents.
    """
    ...
    """
    Input: animal_data (dictionary format) - Criteria to find the document to delete.
    Output: Returns the number of documents removed from the collection.
    """
